...
// persistence target indicates dev, local, prod properties; local is default
@PropertySource({"classpath:persistence-${persistenceTarget:local}.properties"}) // Reading properties file
